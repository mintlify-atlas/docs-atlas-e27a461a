...
description: "Segmented horizontal progress bar for visualising proportional data across multiple categories, with configurable meter size, label markers, and icon tokens."
---

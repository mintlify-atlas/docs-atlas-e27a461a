---
title: "Toast Notifications with Nettalco Severity Colors"
sidebarTitle: "Toast"
description: "Transient overlay messages for success, info, warn, and error states, styled with Nettalco's custom semantic color palette and glassmorphism blur."
---
...
|---|---|---|---|---|---|
| `info` | `color-mix(in srgb, {info.50}, transparent 5%)` | `{info.200}` | `{info.600}` | `{surface.700}` | `0px 4px 8px color-mix(in srgb, {info.500}, transparent 96%)` |
| `success` | `color-mix(in srgb, {success.50}, transparent 5%)` | `{success.200}` | `{success.600}` | `{surface.700}` | `0px 4px 8px color-mix(in srgb, {success.500}, transparent 96%)` |
| `warn` | `color-mix(in srgb, {warn.50}, transparent 5%)` | `{warn.200}` | `{warn.600}` | `{surface.700}` | `0px 4px 8px color-mix(in srgb, {warn.500}, transparent 96%)` |
| `error` | `color-mix(in srgb, {error.50}, transparent 5%)` | `{error.200}` | `{error.600}` | `{surface.700}` | `0px 4px 8px color-mix(in srgb, {error.500}, transparent 96%)` |
| `secondary` | `{surface.100}` | `{surface.200}` | `{surface.600}` | `{surface.700}` | — |
| `contrast` | `{surface.900}` | `{surface.950}` | `{surface.50}` | `{surface.0}` | — |
